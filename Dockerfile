...
RUN sudo apt-get upgrade && sudo apt-get update -y && sudo apt-get install wine-stable -y && sudo apt-get install pv -y && sudo apt-get install python && sudo dpkg --add-architecture i386 && sudo apt update && sudo apt -y install wine32
